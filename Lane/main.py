...
def convert_to_HSV(frame):
    ...
    if (cv2.waitKey(0) & 0xff) == ord('q'): 
        cv2.imwrite('C:/Users/skldd/Desktop/cap/RESTART/HSV.jpg',hsv)
    cv2.imshow("HSV",hsv)
    return hsv
...
def detect_edges(frame):
    ...
    if (cv2.waitKey(0) & 0xff) == ord('q'):
        cv2.imwrite('C:/Users/skldd/Desktop/cap/RESTART/edges.jpg',edges)
...
def region_of_interest(edges):
    ...
    if (cv2.waitKey(0) & 0xff) == ord('q'):
        cv2.imwrite('C:/Users/skldd/Desktop/cap/RESTART/crop.jpg',cropped_edges)
...
while True:
    ...
    if (cv2.waitKey(0) & 0xff) == ord('q'):
        cv2.imwrite('C:/Users/skldd/Desktop/cap/RESTART/result.jpg',heading_image)
